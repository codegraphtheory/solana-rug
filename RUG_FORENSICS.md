...
**Source code used:** `solana-rug` v1.4.0 (see §3a for version history)
...
| Sniper Detection | 10 | 0 | ✅ Not detected by CLI heuristics (see §3a) |
| Suspicious Name | 5 | 5 | 🔴 Token named "Rugpull" — discourages organic buyers |
| Sub-Penny Price | 5 | 5 | 🔴 $0.000012 — typical of dead/low-activity tokens |
| Deployer Dump Risk | 5 | 5 | 🔴 Deployer holds 6.8% — could sell at any time |
| **Total Risk** | **125** | **21** | **Safety Score: 79/100 — LOW** |

### 3a. Score Version Reconciliation

The original RUG_FORENSICS report (v0.1.0, June 2 2026) scored $RUG at **94/100**. The current scoring engine (v1.4.0, June 4 2026) scores it at **79/100**.

| Scoring Factor | v0.1.0 | v1.4.0 | Delta |
|----------------|:------:|:------:|:-----:|
| Suspicious Name | Not scored | 5 pts | +5 |
| Sub-Penny Price | Not scored | 5 pts | +5 |
| Deployer Dump Risk | Not scored | 5 pts | +5 |
| **Total delta** | **—** | **—** | **+15** |

The entire score change is explained by three new risk factors that were added to the scoring engine after the original forensic report was published. The token itself has not changed — the detector got stricter.

This is intentional: adding granular risk factors means fewer blind spots, not a worse token. The 79/100 score is still **LOW RISK** and the forensic analysis in §4-7 remains accurate.
...
*Generated by solana-rug v1.4.0 · On-chain data via public Solana RPC · Market data via DexScreener API*  
